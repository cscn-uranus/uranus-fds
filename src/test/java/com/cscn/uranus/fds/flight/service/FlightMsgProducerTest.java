...
public class FlightMsgProducerTest {
  ...
  public void singleMessageProduced() throws Exception {
    ...
    assertEquals("Queue length should be 1", 1, this.amqManager.getQueueSize(QUEUE_NAME));
  }
  ...
  public void multipleMessageProduced() throws Exception {
    ...
    assertEquals("Queue length should be 120", 120, this.amqManager.getQueueSize(QUEUE_NAME));
  }
  ...
  public void thresholdMessageProduced() throws Exception {
    ...
    assertEquals("Queue length should be 350", 350, this.amqManager.getQueueSize(QUEUE_NAME));
  }
  ...
  public void overflowMessageProduced() throws Exception {
    ...
    assertEquals("Queue length should be 50", 50, this.amqManager.getQueueSize(QUEUE_NAME));
  }
}
